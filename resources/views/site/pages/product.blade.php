                                ...
                                <article class="gallery-wrap">
                                    @if ($product->images->count() > 0)
                                        <div class="img-big-wrap">
                                            <div class="padding-y">
                                                <a href="{{ asset('storage/'.$product->images->first()->full) }}" id="expandedBox" data-fancybox="">
                                                    <img src="{{ asset('storage/'.$product->images->first()->full) }}" alt="" id="expandedImg" style="height: auto;width: 100%;">
                                                </a>
                                            </div>
                                        </div>
                                    @else
                                        ...
                                        <div class="img-small-wrap">
                                            @foreach($product->images as $image)
                                                <div class="item-gallery">
                                                    <img class="thumb-img" src="{{ asset('storage/'.$image->full) }}" alt="" onclick="myFunction(this);">
                                                </div>
                                            @endforeach
                                        </div>
                                    @endif
...
@push('scripts')
    <script>
        ...
        function myFunction(imgs) {
            ...
            expandedBox.href = expandImg.src;
