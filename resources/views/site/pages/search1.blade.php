...
<header class="mb-3">
		<div class="form-inline">
			...
			<div class="btn-group">
				<a href="{{ url('/search/1') }}" class="btn btn-light active" data-toggle="tooltip" title="List view"> 
					<i class="fa fa-bars"></i></a>
				<a href="{{ url('/search/2') }}" class="btn btn-light" data-toggle="tooltip" title="Grid view"> 
