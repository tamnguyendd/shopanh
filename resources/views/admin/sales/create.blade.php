    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="tile">
                ...
                <form action="{{ route('admin.sales.store') }}" method="POST" role="form" >
                    @csrf
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('sale_exp') is-invalid @enderror" placeholder="2099/02/28 15:00:00" type="text" name="sale_exp" id="sale_exp" value="{{ old('sale_exp') }}"/>
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="checkbox" id="active" name="active"/>Show this event in Homepage
                                </label><br>
