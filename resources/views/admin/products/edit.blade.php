                            ...
                            <div class="tile-footer">
                                <div class="row d-print-none mt-2">
                                    <div class="col-12 text-right">
                                        <button class="btn btn-success self_button" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Update Product</button>
                ...
                <div class="tab-pane" id="images">
                    <div class="tile">
                        ...
                        <div class="tile-body">
                            ...
                            <div class="row d-print-none mt-2">
                                <div class="col-12 text-right">
                                    <button class="btn btn-success self_button" type="button" id="uploadButton">
...
@push('scripts')
    ...
    <link href="{{ asset('backend/js/plugins/dropzone/dist/dropzone.css') }}" rel="stylesheet" />
    <script>
